!(function(e) {
  ...
  function(e, t, n) {
    (e.exports = n(3)(!1)).push([
      e.i,
      "body{background:#00f}p{font-size:calc(12px + 9*(100vw - 420px)/860)}@media screen and (min-width:1280px){p{font-size:21px}}@media screen and (max-width:420px){p{font-size:12px}}",
      ""
    ]);
  },
  function(e, t, n) {
